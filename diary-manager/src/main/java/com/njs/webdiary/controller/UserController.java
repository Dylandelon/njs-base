...
import com.njs.webdiary.service.QiniuService;
...
public class UserController {
    ...
    public String toMyProfile(HttpSession session,Model model) {
        ...
        UserEntity user = userService.getProfile(sessionUid, sessionUid);
        List<PostEntity> postList =  postService.getPostList(sessionUid);
    ...
    public String toProfile(int uid,Model model,HttpSession session) {
        ...
        //获得用户信息
        UserEntity user = userService.getProfile(sessionUid, uid);
        //获得发帖列表
        List<PostEntity> postList =  postService.getPostList(uid);
        //向模型中添加数据
    ...
    public String toEditProfile(HttpSession session,Model model){
        ...
        UserEntity user = userService.getEditInfo(uid);
        model.addAttribute("user",user);
        return "editProfile";
    }
